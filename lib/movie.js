  ...
  _createClass(Movie, [{
    ...
    value: function () {
      var _get = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(endpoint) {
        var r, $, poster, writers, writersElements, cast, castElements;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _requestPromiseNative["default"])("".concat(endpoint, "/title/").concat(this.id, "/"));
            case 2:
              r = _context.sent;
              $ = cheerio.load(r);
              this.title = $('h1[data-testid="hero__pageTitle"]').text().trim();
              poster = $('div[data-testid="hero-media__poster"] > div.ipc-media__img > img').attr('src');
              if (poster !== undefined) {
              ...
              writers = [];
              writersElements = $('li[data-testid="title-pc-principal-credit"]:nth-child(2) > div').first().find('ul > li > a');
              writersElements.each(function () {
                writers.push($(this).text().trim());
              });
              this.writers = writers;
              cast = [];
              castElements = $('a[data-testid="title-cast-item__actor"]');
              castElements.each(function () {
    ...
    key: "getContentRating",
    value: function getContentRating() {
    ...
    key: "getMetascore",
    value: function getMetascore() {
      return this.metascore;
    }
  }, {
    key: "getWriters",
    value: function getWriters() {
      return this.writers;
    }
  }, {
    key: "getCast",
